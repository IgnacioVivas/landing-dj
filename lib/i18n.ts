...
const es = {
  ...
  shows: {
    ...
    showMorePast: 'Ver más shows anteriores',
    tickets: 'Tickets',
    soldOut: 'Sold Out',
  },
  multimedia: {
  ...
  pressKit: {
    ...
    title:          'Press Kit',
    rider:          'Rider Técnico',
    epk:            'Descargar contenido',
    download:       'Descargar',
    locked:         'Contenido protegido',
    lockHint:       'Ingresá la contraseña para acceder al press kit.',
    pwdPlaceholder: 'Contraseña',
    unlock:         'Acceder',
    wrongPwd:       'Contraseña incorrecta.',
    unlocking:      'Verificando...',
    equipment:      'Equipamiento DJ',
    monitoring:     'Monitoreo',
    ergonomics:     'Ergonomía y cabina',
    hospitality:    'Hospitality',
    stagePlot:      'Esquema de escenario',
    promoFolder:    'Material de prensa en alta calidad',
  },
  countdown: {
...
const en = {
  ...
  shows: {
    ...
    past: 'Past shows',
    showMorePast: 'Show more past shows',
    tickets: 'Tickets',
    soldOut: 'Sold Out',
  },
  multimedia: {
  ...
  pressKit: {
    ...
    epk:            'Download content',
    download:       'Download',
    locked:         'Protected content',
    lockHint:       'Enter the password to access the press kit.',
    ...
    ergonomics:     'Ergonomics & booth',
    hospitality:    'Hospitality',
    stagePlot:      'Stage plot',
    promoFolder:    'High-res press material',
  },
  countdown: {
    overline: 'Next show',
    days:     'DAYS',
