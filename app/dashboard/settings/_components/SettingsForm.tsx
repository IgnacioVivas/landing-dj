...
function toDefaults(d: UserSettings): SettingsInput {
  return {
    ...
    pageBackgroundOverlayOpacity: d.settings?.pageBackgroundOverlayOpacity ?? 75,
    pageBackgroundBlur:           d.settings?.pageBackgroundBlur           ?? 0,
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-12">
      <ThemeSection
        ...
        initialFaviconUrl={data.settings?.faviconUrl ?? null}
        initialPageBackgroundUrl={data.settings?.pageBackgroundUrl ?? null}
