...
export async function updateSettingsAction(data: unknown): Promise<ActionResult> {
  ...
  const {
    ...
    accentColor, accentColor2, heroTitle, heroTitleEn, heroTitleSize, heroContentAlign, heroTextColor, heroOverlay, heroLayout, scrollMode, showStats, pageBackgroundOverlay,
  } = parsed.data
  ...
  await db.$transaction([
    ...
    db.djSettings.upsert({
      ...
      update: {
        ...
        accentColor, accentColor2, heroTitle: toNull(heroTitle), heroTitleEn: toNull(heroTitleEn), heroTitleSize, heroContentAlign, heroTextColor, heroOverlay, heroLayout, scrollMode, showStats, pageBackgroundOverlay,
      },
      create: {
