	...
	return (
		<div>
			...
			>
				...
				{total === 0 ? (
					<p className="font-mono text-xs text-slate-600 text-center py-10">Todavía no hay visitas registradas.</p>
				) : (
					<>
									...
									<div key={device} className="flex flex-col gap-1.5">
										...
										<div className="h-1.5 w-full rounded-full bg-white/5 overflow-hidden">
											<div
												...
												style={{ width: `${pct}%`, background: 'var(--dj-accent)' }}
											/>
										</div>
									</div>
								);
					...
					>
						<div className="flex items-center justify-between mb-5">
							...
							{countries.some((c) => c.country === UNKNOWN) && (
								<p className="font-mono text-xs text-slate-600">* detección activa</p>
							)}
						</div>
